...
<div class="brain-page">
	...
	<main class="brain-container">
		...
		<section class="brain-hero">
			...
			<div class="hero-stats">
				...
				<div class="stat-pill">
					<span class="stat-num">{categories.filter((c) => c !== 'hub').length}</span>
		...
		<section class="controls-section">
			...
			<div class="category-tabs" role="tablist">
				...
				{#each categories.filter((c) => c !== 'hub') as cat}
					<button
						class="tab-btn"
				...
				<div class="notes-grid">
					{#each filteredNodes as node (node.slug)}
						<article class="note-card">
							<a href="/brain/{node.slug}" class="card-inner-link">
								<div class="card-top">
	...
	<footer class="brain-footer">
		<div class="footer-links">
			...
			<a href="https://github.com/andrea-de/brain" target="_blank" rel="noopener">GitHub Repo</a>
